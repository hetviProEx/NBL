...
export const GET_SALES_BY_ID_INITIATED = "GET_SALES_BY_ID_INITIATED";
export const GET_SALES_BY_ID_SUCCESS = "GET_SALES_BY_ID_SUCCESS";
export const GET_SALES_BY_ID_ERROR = "GET_SALES_BY_ID_ERROR";

export const DELETE_SALES_INITIATED = "DELETE_SALES_INITIATED";
export const DELETE_SALES_SUCCESS = "DELETE_SALES_SUCCESS";
export const DELETE_SALES_ERROR = "DELETE_SALES_ERROR";

export const GET_SALES_DASHBOARD_INITIATED = "GET_SALES_DASHBOARD_INITIATED";
export const GET_SALES_DASHBOARD_SUCCESS = "GET_SALES_DASHBOARD_SUCCESS";
export const GET_SALES_DASHBOARD_ERROR = "GET_SALES_DASHBOARD_ERROR";

export const IMPORT_PROSPECT_INITIATED = "IMPORT_PROSPECT_INITIATED";
export const IMPORT_PROSPECT_SUCCESS = "IMPORT_PROSPECT_SUCCESS";
export const IMPORT_PROSPECT_ERROR = "IMPORT_PROSPECT_ERROR";

export const GET_LEADS_MEETING_INITIATED = "GET_LEADS_MEETING_INITIATED";
export const GET_LEADS_MEETING_SUCCESS = "GET_LEADS_MEETING_SUCCESS";
export const GET_LEADS_MEETING_ERROR = "GET_LEADS_MEETING_ERROR";